...
export default function QuotesPage() {
  ...
  const INP: React.CSSProperties = { width: "100%", padding: "8px 10px", border: `1px solid ${BORDER}`, borderRadius: BTN_RADIUS, fontSize: 13, outline: "none", background: WHITE, boxSizing: "border-box" };
    ...
    <div className="page-pad" style={{ padding: "26px 28px" }}>
      ...
      <div className="quotes-layout" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {/* Client */}
          <div style={{ background: WHITE, border: `1px solid ${BORDER}`, borderRadius: CARD_RADIUS, padding: 20 }}>
            ...
            {selectedClient && (
              <div style={{ marginTop: 12, padding: "10px 14px", background: BG, borderRadius: BTN_RADIUS, border: `1px solid ${BORDER}`, fontSize: 12, display: "flex", flexWrap: "wrap", gap: "4px 20px" }}>
          ...
          <div style={{ background: WHITE, border: `1px solid ${BORDER}`, borderRadius: CARD_RADIUS, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                return (
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "2fr 80px 100px 28px", gap: 8, alignItems: "end", minWidth: 340 }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", border: `1px solid ${BORDER}`, borderRadius: BTN_RADIUS, overflow: "hidden" }}>
              ...
              <button onClick={addLine}
                style={{ alignSelf: "flex-start", fontSize: 12, padding: "6px 14px", borderRadius: BTN_RADIUS, border: `1px dashed ${BORDER}`, background: WHITE, color: BLUE, cursor: "pointer", fontWeight: 600 }}>
                + Add line
              </button>
            </div>
          </div>
                ...
                <div key={l.key}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                    ...
                    <button onClick={() => setPerPc(p => ({ ...p, [l.key]: !p[l.key] }))}
                      style={{ fontSize: 9, fontWeight: 700, padding: "2px 7px", borderRadius: BTN_RADIUS, cursor: "pointer", border: "none", background: perPc[l.key] ? BLUE + "18" : BG, color: perPc[l.key] ? BLUE : MID }}>
        ...
        <div className="quotes-sticky" style={{ position: "sticky", top: 24 }}>
          <div style={{ background: WHITE, border: `1px solid ${BORDER}`, borderRadius: CARD_RADIUS, padding: 24 }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 20, padding: "20px 0", borderBottom: `1px solid ${BORDER}` }}>
              ...
              {totalSaleValue > 0 && (
                <div style={{ marginTop: 8, fontSize: 11, fontWeight: 600, padding: "4px 14px", borderRadius: BTN_RADIUS, display: "inline-block", background: mc + "15", color: mc }}>
            ...
            {totalQty > 0 && totalSaleValue > 0 && (
              <div style={{ background: BG, borderRadius: BTN_RADIUS, border: `1px solid ${BORDER}`, padding: "12px 14px", marginBottom: 20, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, fontSize: 12 }}>
