...
INVOICE LINKS:
- When asked for an invoice, fetch the order with get_orders, show the invoice details, then add a download link on a new line: https://printribe-crm.vercel.app/invoice/view?id=[ORDER_ID]
